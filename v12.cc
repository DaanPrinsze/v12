...
{
	srand ( time (NULL) );
	//intitialiseert randomgeneratoor
...
//sJBoolG==1 als geboortejaar is schrikkeljaar
int maandLengteG [13] = {0,31,28,31,30,31,30,31,31,30,31,30,31 };
		maandLengteG [2] += sJBoolG;                                                
		//als geboortejaar is schrikkeljaar, dan februari 29 dagen
  ...
  cout << psVnw << " bent " << lJ << " jaar en " << lM - (12 * lJ)
	...
	int dagenSinds; 								
	//Totaal dagen van 1/1/1900 tot gD/gM/gJ
  ...
  //een array waar de gebruiker de eerste 2 letters
 ...
 //maak van de 2 letter inputs een int-waarde
 int wkNmr; 
 //maakt van de letter-input intwaarde een getal van 0 tot 6
	if (wkDag == 109) wkNmr = 0; 
	//maakt gebruik van numerieke waarde van de ASCI
	//karakters m, d, w, v, z, i, a, o
